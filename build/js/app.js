...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HeaderHeaderJsx = __webpack_require__(157);

	var _HeaderHeaderJsx2 = _interopRequireDefault(_HeaderHeaderJsx);

	var _ProductSelectProductSelectJsx = __webpack_require__(188);

	var _ProductSelectProductSelectJsx2 = _interopRequireDefault(_ProductSelectProductSelectJsx);

	var _storesBasketStore = __webpack_require__(190);

	var _storesBasketStore2 = _interopRequireDefault(_storesBasketStore);

	var _BasketListBasketListJsx = __webpack_require__(202);

	var _BasketListBasketListJsx2 = _interopRequireDefault(_BasketListBasketListJsx);

	var _BasketTotalBasketTotalJsx = __webpack_require__(205);
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            return _react2["default"].createElement(
	                "div",
	                null,
	                _react2["default"].createElement(_HeaderHeaderJsx2["default"], null),
	                _react2["default"].createElement(_ProductSelectProductSelectJsx2["default"], null),
	                _react2["default"].createElement(_BasketListBasketListJsx2["default"], null),
	                _react2["default"].createElement(_BasketTotalBasketTotalJsx2["default"], null),
	                _react2["default"].createElement(_ProductCardsProductCardsJsx2["default"], null)
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _headerScss = __webpack_require__(187);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashLangIsObject2 = __webpack_require__(159);
	...
	var _linkClass = __webpack_require__(160);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashLangIsArray2 = __webpack_require__(161);
	...
	var _makeConfiguration = __webpack_require__(167);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashCollectionForEach2 = __webpack_require__(168);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayEach = __webpack_require__(169),
	    baseEach = __webpack_require__(170),
	    createForEach = __webpack_require__(184);
...
/***/ function(module, exports) {
	...
	module.exports = {"dashed-borders":"_3tqv179kx8vLIRSVuovmF2","centred":"_17mLdcFMjK06jI8s9WUAGd","green-text":"_3LBSqjMooSDjZy02-i7-U-","white-background":"_2_dO4Et5yry2J6PzA-0nWK","font":"_1cyKEkDrjUdGKFGXcPHuhs","header-sass":"_2jIz-YrQWGKHPf8z09V3Bx","header-styles":"_2rhST2Uu0srIcGh23uleqZ _17mLdcFMjK06jI8s9WUAGd _2_dO4Et5yry2J6PzA-0nWK _3LBSqjMooSDjZy02-i7-U-","not-bold":"_5CPzC6pbcGAIlWRK524U7","large-text":"_3Ku5uE6pBEL4Eq65Bfk4Td"};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _productSelectScss = __webpack_require__(189);

	var _productSelectScss2 = _interopRequireDefault(_productSelectScss);

	var _storesBasketStore = __webpack_require__(190);

	var _storesBasketStore2 = _interopRequireDefault(_storesBasketStore);

	var _actionsBasketActions = __webpack_require__(200);

	var _utilsGetProducts = __webpack_require__(201);
	...
	var AddProduct = (function (_React$Component) {
	    ...
	    function AddProduct() {
	        ...
	        _get(Object.getPrototypeOf(AddProduct.prototype), "constructor", this).call(this);
	        this.state = {
	            products: []
	        };
	        this.unique = 0;
	        _storesBasketStore2["default"].subscribe(this.updateDisplayIndex.bind(this));
	    }
	    ...
	    _createClass(AddProduct, [{
	        ...
	        value: function componentWillMount() {
	            ...
	            (0, _utilsGetProducts.getProducts)().then(function (data) {
	                _this.setState({
	        ...
	        value: function render() {
	            ...
	            return _react2["default"].createElement(
	                "div",
	                { className: "col-sm-4 col-sm-offset-4", styleName: "add-product-holder" },
	                _react2["default"].createElement(
	                    "h2",
	                    {
	                        styleName: "title" },
	        ...
	        value: function addProduct() {
	            var options = _react2["default"].findDOMNode(this.refs.addProduct).options;
	            var selected = options[options.selectedIndex];
	            _storesBasketStore2["default"].dispatch((0, _actionsBasketActions.addProduct)({
	                name: selected.value,
	        ...
	        key: "onProductChange",
	        value: function onProductChange() {
	            var options = _react2["default"].findDOMNode(this.refs.addProduct).options;
	            _storesBasketStore2["default"].dispatch((0, _actionsBasketActions.updateDisplayIndex)(options.selectedIndex));
	        }
	    }, {
	        key: "updateDisplayIndex",
	        value: function updateDisplayIndex() {
	            var options = _react2["default"].findDOMNode(this.refs.addProduct).options;
	            options.selectedIndex = _storesBasketStore2["default"].getState().displayIndex;
	        }
	    }]);
	...
	exports["default"] = (0, _reactCssModules2["default"])(AddProduct, _productSelectScss2["default"]);
	module.exports = exports["default"];
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"add-product-holder":"jYJRKW1T2-p6fza6sHwDr","title":"_2cA2wnBc29QPvJxkSQWApi","select-styles":"_1XgJBNYU5eCTEZe9SUDzuR","button-styles":"_2OnoWevmJO3RB5XiKv78sm"};
...
/***/ function(module, exports, __webpack_require__) {
	...
	function updateBasket() {
	    ...
	    switch (action.type) {
	        ...
	        case "REMOVE":
	            return state.filter(function (prod) {
	                return prod.id !== action.state.id;
	            });
	        default:
	            return state;
	    }
	...
	function updateDisplayedProductIndex() {
	...
	function getBasketTotal(products) {
	    if (!products || !products.length) {
	        ...
	        return products.map(function (product) {
	            return product.cost;
	        }).reduce(function (price, nxtPrice) {
	            return Number(price) + Number(nxtPrice);
	        });
	    }
	}

	var basketStore = (0, _redux.createStore)(basketApp);
...
/***/ function(module, exports) {
	...
	exports.updateDisplayIndex = updateDisplayIndex;
	var ADD = "ADD";
	var REMOVE = "REMOVE";
	var UPDATEDISPLAYINDEX = "UPDATEDISPLAYINDEX";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _basketListScss = __webpack_require__(203);

	var _basketListScss2 = _interopRequireDefault(_basketListScss);

	var _storesBasketStore = __webpack_require__(190);

	var _storesBasketStore2 = _interopRequireDefault(_storesBasketStore);

	var _utilsAnimatorMin = __webpack_require__(204);

	var _utilsAnimatorMin2 = _interopRequireDefault(_utilsAnimatorMin);

	var _actionsBasketActions = __webpack_require__(200);

	var BasketList = (function (_React$Component) {
	    _inherits(BasketList, _React$Component);

	    function BasketList() {
	        _classCallCheck(this, BasketList);

	        _get(Object.getPrototypeOf(BasketList.prototype), "constructor", this).call(this);
	        this.state = {
	            products: []
	        };
	        _storesBasketStore2["default"].subscribe(this.basketUpdate.bind(this));
	    }
	    ...
	    _createClass(BasketList, [{
	            ...
	            return this.state.products.map(function (product, i) {
	                return _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement("i", {
	                        ...
	                        styleName: "close",
	                        onClick: _this.removeProduct.bind(_this) })
	                );
	            });
	        }
	    }, {
	        key: "animateBasketList",
	        value: function animateBasketList() {
	            var listItems = this.createList();
	            var styles = { height: (!listItems.length ? 0 : 50 + listItems.length * 40) + "px" };
	            var basketList = _react2["default"].findDOMNode(this.refs.basketList);
	            var item = basketList.querySelectorAll(".basket-product")[!listItems.length ? 0 : listItems.length - 1];
	            var sequence = _utilsAnimatorMin2["default"].transition({
	                element: basketList,
	                properties: "height",
	                setStyles: {
	                    before: styles
	            ...
	            sequence.then(function () {
	                if (item) {
	                    return _utilsAnimatorMin2["default"].transition({
	                        element: item,
	                        properties: "opacity",
	                        setStyles: {
	                            before: {
	        ...
	        key: "basketUpdate",
	        value: function basketUpdate() {
	            this.setState({
	                products: _storesBasketStore2["default"].getState().inBasket
	            });
	        }
	    }, {
	        key: "removeProduct",
	        value: function removeProduct(evt) {
	            var product = evt.target.parentNode;
	            _storesBasketStore2["default"].dispatch((0, _actionsBasketActions.removeProduct)({
	...
	exports["default"] = (0, _reactCssModules2["default"])(BasketList, _basketListScss2["default"]);
	module.exports = exports["default"];
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"basket-list":"_2m0V-BnVBhCMWTVieqCxwF","close":"uE2BoVzic5ZNjWpgj53iM"};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BasketTotal = (function (_React$Component) {
	    _inherits(BasketTotal, _React$Component);

	    function BasketTotal() {
	        _classCallCheck(this, BasketTotal);

	        _get(Object.getPrototypeOf(BasketTotal.prototype), "constructor", this).call(this);
	        this.state = {
	            total: 0
	        };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProductCards = (function (_React$Component) {
	    ...
	    function ProductCards() {
	        ...
	        _get(Object.getPrototypeOf(ProductCards.prototype), "constructor", this).call(this);
	        this.state = {
	            cards: [],
	            displayIndex: 0,
	            lastIndex: 0
	    ...
	    _createClass(ProductCards, [{
	        ...
	        key: "render",
	        value: function render() {
	            var card = this.state.cards[this.state.displayIndex];
	            if (!card) {
	                return false;
	            } else {
	                return _react2["default"].createElement(
	        ...
	        key: "addProduct",
	        value: function addProduct() {
	            var card = _react2["default"].findDOMNode(this.refs.card);
	            var selected = this.state.cards[this.state.displayIndex];
	            _storesBasketStore2["default"].dispatch((0, _actionsBasketActions.addProduct)({
	                name: selected.name,
	                cost: selected.cost,
	        ...
	        key: "animateCardEntrance",
	        value: function animateCardEntrance() {
	            var _this2 = this;

	            var card = _react2["default"].findDOMNode(this.refs.card);
	            var prev = this.state.lastIndex;
	            var next = this.state.displayIndex;
	            var animation = prev === next ? "bounceInDown" : "fadeInUp";
	            var duration = _utilsAnimatorMin2["default"].getPrefix("animation-duration");
	            _utilsAnimatorMin2["default"].setStyles(card, _utilsAnimatorMin2["default"].createCSSRule(duration, "0.2s"));
	            var sequence = _utilsAnimatorMin2["default"].animation({
	                element: card,
	                addClass: {
	                    before: animation
	                },
	            ...
	            sequence.then(function () {
	                _this2.cardControlsEnabled = true;
	            });
	        }
	    }, {
	        key: "getUniqueId",
	        ...
	        key: "showNextProduct",
	        value: function showNextProduct() {
	            if (this.cardControlsEnabled) {
	                this.cardControlsEnabled = false;
	                _storesBasketStore2["default"].dispatch((0, _actionsBasketActions.updateDisplayIndex)(this.state.displayIndex === this.state.cards.length - 1 ? 0 : this.state.displayIndex + 1));
	            }
	        }
	    }, {
	        key: "showPrevProduct",
	        value: function showPrevProduct() {
	            if (this.cardControlsEnabled) {
	                this.cardControlsEnabled = false;
	                _storesBasketStore2["default"].dispatch((0, _actionsBasketActions.updateDisplayIndex)(this.state.displayIndex > 0 ? this.state.displayIndex - 1 : this.state.cards.length - 1));
	            }
	        }
	    }, {
	        key: "updateDisplayIndex",
	        value: function updateDisplayIndex() {
	            this.setState({
	                ...
	                displayIndex: _storesBasketStore2["default"].getState().displayIndex
	            });
	        }
	    }]);
	...
	exports["default"] = (0, _reactCssModules2["default"])(ProductCards, _productCardsScss2["default"], { allowMultiple: true });
	module.exports = exports["default"];
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"card-holder":"t1_ClsiD-WsGwaaSs_Nha","card-control":"_2c4Y3cpA9UZWsEzJi8XJxW","left":"_1U9-x9Cz7bN0oagmmv_EzF","right":"_2mTsZai-v0ZtFai8f02W57","card":"L3bbzS2DGrjJfkXi-dwoT","desc":"p9aCByEIwZoEyVM5e_aWK","cost":"_1KUutIiUAXqO9ZbRvr14il","button-styles":"FRI33RZjU2FuxoxvopCGr"};
